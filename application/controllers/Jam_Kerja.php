...
class Jam_Kerja extends CI_Controller {
	...
	public function hapus_jam_kerja_pegawai()
	{
		$id = $this->input->post('id_user');
		$id_jam_kerja = $this->input->post('id_jam_kerja');

			$hasil = $this->m_jam_kerja->delete_jam_kerja($id_jam_kerja);
	...
	public function edit_jam_kerja_admin()
	{
		$id = $this->input->post('id_user');
		$id_jam_kerja = $this->input->post('id_jam_kerja');
		$jam_kerja_start = $this->input->post('jam_kerja_start');
	...
	public function hapus_jam_kerja_admin()
	{
		$id = $this->input->post('id_user');
		$id_jam_kerja = $this->input->post('id_jam_kerja');
